...
class TestAmenity(unittest.TestCase):
    """ Testing an Amenity instance """

    def setUp(self):
        """
        Setting up the test instance
        """
        self.my_base1 = Amenity()
        self.my_base2 = Amenity()
    ...
    def test_create(self):
        """
        Testing creation of an Amenity instance
        """
        self.assertIsInstance(self.my_base1, Amenity)
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(obj['__class__'], 'Amenity')
