...
class TestReview(unittest.TestCase):
    """ Testing an Review instance """

    def setUp(self):
        """
        Setting up the test instance
        """
        self.my_base1 = Review()
        self.my_base2 = Review()
    ...
    def test_create(self):
        """
        Testing creation of an Review instance
        """
        self.assertIsInstance(self.my_base1, Review)
    ...
    def test_docstring(self):
        """
        Testing documentation on review
        """
